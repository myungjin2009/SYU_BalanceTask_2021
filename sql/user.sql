CREATE TABLE `user` (
	...
	`name` VARCHAR(50) NOT NULL DEFAULT '11' COLLATE 'utf8_general_ci',
	...
	`user_image` VARCHAR(750) NULL DEFAULT NULL COLLATE 'utf8_general_ci',
	...
	`jwt` VARCHAR(750) NULL DEFAULT NULL COLLATE 'utf8_general_ci',
